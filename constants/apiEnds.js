...
export const API_ENDPOINTS = {
  ...
  ADMIN_STATS: `${BACKEND_URL}/api/v1/admin/dashboard-stats/`,
  ADMIN_USERS: `${BACKEND_URL}/api/v1/admin/users/`,
  ADMIN_USER_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/users/${id}/`,
  ADMIN_AUTHORS: `${BACKEND_URL}/api/v1/admin/authors/`,
  ADMIN_AUTHOR_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/authors/${id}/`,
  ADMIN_BOOKS: `${BACKEND_URL}/api/v1/admin/books/`,
  ADMIN_BOOK_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/books/${id}/`,
  ADMIN_CATEGORIES: `${BACKEND_URL}/api/v1/admin/categories/`,
  ADMIN_CATEGORY_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/categories/${id}/`,
  ADMIN_ORDERS: `${BACKEND_URL}/api/v1/admin/orders/`,
  ADMIN_ORDER_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/orders/${id}/`,
  ADMIN_BLOGS: `${BACKEND_URL}/api/v1/admin/blogs/`,
  ADMIN_BLOG_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/blogs/${id}/`,
  ADMIN_CAROUSELS: `${BACKEND_URL}/api/v1/admin/carousels/`,
  ADMIN_CAROUSEL_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/carousels/${id}/`,
  ADMIN_TESTIMONIALS: `${BACKEND_URL}/api/v1/admin/testimonials/`,
  ADMIN_TESTIMONIAL_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/testimonials/${id}/`,
  ADMIN_SUPPORT: `${BACKEND_URL}/api/v1/admin/support/`,
  ADMIN_SUPPORT_DETAIL: (id) => `${BACKEND_URL}/api/v1/admin/support/${id}/`,
  ADMIN_GENERAL_SETTINGS: `${BACKEND_URL}/api/v1/admin/general-settings/`,
}
